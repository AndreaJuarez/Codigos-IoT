...
//NUBLADO
//"http://api.openweathermap.org/data/2.5/forecast?q=Tijuana,MX&APPID=";

//MAS DE 25 GRADOS
//"http://api.openweathermap.org/data/2.5/forecast?q=Veracruz,MX&APPID=";

const String privateKey = "f0fbe4f0ffd8cb2837dd49302f845aa3";
